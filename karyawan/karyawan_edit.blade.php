...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Karyawan Page </h4><br><br>



    <form method="post" action="{{ route('karyawan.update') }}" id="myForm" enctype="multipart/form-data" >
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="nik" value="{{ $karyawan->nik }}" class="form-control" type="text"    >
                </div>
            </div>
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="nama_karyawan"  value="{{ $karyawan->nama_karyawan }}" class="form-control" type="text"    >
                </div>
            </div>
            <!-- end row -->
  ...
  <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="jabatan" value="{{ $karyawan->jabatan }}" class="form-control" type="text"  >
                </div>
            </div>
            <!-- end row -->
  ...
  <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="departemen" value="{{ $karyawan->departemen }}" class="form-control" type="text"  >
                </div>
            </div>
            <!-- end row -->
       ...
       <input name="karyawan_image" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
   <img id="showImage" class="rounded avatar-lg" src="{{ asset($karyawan->karyawan_image) }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Karyawan">
            </form>
